...
Q1:
- I notice that dist - angle - dist&angle ⇒ have the exactly same accuracy but other metric are diffirent. That's very unlikely to happen, that must be a bug but I did found the source of the bug.
...
![plot_calibration_curve_test_reg](/assets/plot_calibration_curve.png)
![plot_calibration_curve_test_reg](/assets/plot_roc.png)
![plot_calibration_curve_test_reg](/assets/plot_goal_rate_by_percentile.png)
![plot_calibration_curve_test_reg](/assets/plot_cumulative_prop.png)
...
![plot_calibration_curve_test_reg](/assets/plot_calibration_curve_test_reg.png)
![plot_calibration_curve_test_reg](/assets/plot_roc_test_reg.png)
![plot_calibration_curve_test_reg](/assets/plot_goal_rate_by_percentile_test_reg.png)
![plot_calibration_curve_test_reg](/assets/plot_cumulative_prop_test_reg.png)




1. **test models on Playoffs**:
![plot_calibration_curve_test_reg](/assets/plot_calibration_curve_test_playoffs.png)
![plot_calibration_curve_test_reg](/assets/plot_roc_test_playoffs.png)
![plot_calibration_curve_test_reg](/assets/plot_goal_rate_by_percentile_test_playoffs.png)
![plot_calibration_curve_test_reg](/assets/plot_cumulative_prop_test_playoffs.png)
